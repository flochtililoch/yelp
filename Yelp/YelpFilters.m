...
+ (NSMutableArray *)initialize {
    ...
    NSArray *filtersDefinition = @[
                                   @{@"id": @"deals_filter", @"title": @"", @"options":@[
                                   ...
                                   @{@"id": @"sort", @"title": @"Sort By", @"options":@[
                                             @{@"name": @"Best Match", @"code":@0, @"selected":@YES},
                                             @{@"name": @"Distance", @"code":@1},
                                             @{@"name": @"Rating", @"code":@2}
                                             ]},
                                   @{@"id": @"category_filter", @"title": @"Category", @"options":@[
    ...
    for (NSDictionary *definition in filtersDefinition) {
        [filters addObject:[[Filter alloc] initWithDictionary:definition]];
    }
    return filters;
}
