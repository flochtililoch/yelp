...
- (id)copyWithZone:(NSZone *)zone {
    YelpFilters *copy = [[[self class] allocWithZone:zone] init];
    if (copy) {
        copy.hasDeals = self.hasDeals;
        copy.sortMode = self.sortMode;
        copy.selectedCategories = [NSMutableSet setWithSet:self.selectedCategories];
    }
    return copy;
}
